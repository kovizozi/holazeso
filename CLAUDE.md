...
6. **A radar-animáció adatvezérelt, nem időzített**: egy kör pontjai egyszerre villannak fel, nem szétdobálva időben, és SOSEM előbb, mint ahogy a valódi Open-Meteo válasz megérkezik. A sugár csak akkor nő, ha az előző kör válasza megjött ÉS nem volt benne találat. Egyetlen kiegészítés: a felfedés megvárja, hogy a pásztázó vonal befejezze az aktuális fordulatát (`waitForSweepPass()`), különben a pontok a vonal első köre előtt jelennének meg. Ez nem kitalált időzítés, csak a meglévő adat megjelenítésének igazítása a pásztázáshoz.
