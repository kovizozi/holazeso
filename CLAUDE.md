...
6. **A radar-animáció adatvezérelt, nem időzített**: egy kör pontjai egyszerre villannak fel, amikor a valódi Open-Meteo válasz megérkezik, nem szétdobálva időben. A sugár csak akkor nő, ha az előző kör válasza megjött ÉS nem volt benne találat.
